...
function checkitem()
    ...
    nowPo = now:FindFirstChild("Pole (1st Form)")
    invenPo = inven:FindFirstChild("Pole (1st Form)")
    ...
    if nowPo then
        print("Have PoleV1 in hand")
        poC = true
    elseif invenPo then
        print("Have PoleV1 in inven")
        poC = true
    else
        print("No PoleV1 Bitch")
        poC = false
    end
...
poIM = "rbxthumb://type=Asset&id=" .. 9547403926 .. "&w=420&h=420" --po
...
if Ima1 == nil then
    ...
    elseif holC == true and alhol == false then
        ...
        alhol = true
        print("holy")
    elseif poC == true and alpo == false then
        Ima1 = poIM
        alpo = true
        print("pole1")
    end
...
if Ima16 == nil then
    if holC == true and alhol == false then
        Ima16 = holIM
        alhol = true
    elseif poC == true and alpo == false then
        Ima16 = poIM
